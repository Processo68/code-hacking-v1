...
<div id="wrapper">
    ...
    <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
        ...
        <?php /*<?php if(!Request::is('auth/login')): ?>*/ ?>
        ...
        <?php /*<a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false"><?php echo e(auth()->user()->name); ?> <span class="caret"></span></a>*/ ?>
        <?php /*<ul class="dropdown-menu" role="menu">*/ ?>
        <?php /*<li><a href="<?php echo e(url('/auth/logout')); ?>">Logout</a></li>*/ ?>

        <?php /*<li><a href="<?php echo e(url('/admin/profile')); ?>/<?php echo e(auth()->user()->id); ?>">Profile</a></li>*/ ?>
        <?php /*</ul>*/ ?>
        <?php /*</li>*/ ?>
        <?php /*<?php endif; ?>*/ ?>
        <?php /*</ul>*/ ?>
                ...
                <ul class="nav" id="side-menu">
                    ...
                    <li>
                        ...
                        <ul class="nav nav-second-level">
                            ...
                            <li>
                                <a href="<?php echo e(route('admin.categories.create')); ?>">Create Category</a>
                            </li>
